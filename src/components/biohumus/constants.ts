...
export const PRICING_PLANS = [
  {
    ...
    icon: "Package",
    items: [
      { name: "5 литров", price: "100", unit: "за упаковку" },
      { name: "10 литров", price: "200", unit: "за упаковку" },
      { name: "40 литров", price: "800", unit: "за упаковку", badge: "Выгодно" },
    ],
    highlight: false,
  },
  {
    ...
    icon: "Droplets",
    items: [
      { name: "0.5 литра", price: "10", unit: "за флакон" },
      { name: "1 литр", price: "20", unit: "за флакон", badge: "Хит" },
      { name: "5 литров", price: "100", unit: "за канистру" },
    ],
    highlight: true,
  },
  {
